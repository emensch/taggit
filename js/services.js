...
.factory('UserService', function($rootScope) {
	...
	service.updateUserID = function(userID) {
		this.userID = userID;
		$rootScope.$broadcast("userInfoChanged");
	}

	service.updateApiKey = function(apiKey) {
		this.apiKey = apiKey;
		$rootScope.$broadcast("userInfoChanged");
	}
...
.factory('authInterceptor', function(Base64, UserService) {
	var authInterceptor = {
		request: function(config) {
			var authdata = Base64.encode(UserService.userID + ':' + UserService.apiKey);
